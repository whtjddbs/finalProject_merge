...
<div class="header_container">
	<div  class="header_layout">
		...
		<div  class="header_wrap">
			<a href=""><i class="fa fa-user">MYPAGE</i></a>	
			<a href=""><i class="fa fa-heart">MYHEART</i></a>
			<a href=""><i class="fa fa-shopping-basket">SHOPPINGBAG</i></a>
			<a href=""><i class="fa fa-sign-in">LOGIN</i></a>
			<c:if test="${sessionScope.memId != null}">
				<a href=""><i class="fa fa-sign-out-alt">LOGOUT</i></a>
			</c:if>
		</div>
	</div>	
	...
	<div class="header_clearfix" style="margin-top:30px">
		...
		<div class="header_global-nav">
			...
			<ul class="header_nav">
				<li>
					<a href="" class="subMenu2">BEST</a>
					<a href="" class="subMenu2">EVENT</a>
					<a href="" class="subMenu2">SALE</a>
				</li>
			</ul>
